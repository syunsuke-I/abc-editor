...
export const ABC_ANNOTATION_PATTERN = /^"[\^_<>@][^"]*"$/; // 注釈 ("^above", "_below", "<left", ">right", "@x,y" など)
...
export const ABC_INLINE_FIELD_PATTERN = /^\[([ABCDFGHIKLMmNOPQRrSsTUVWwXZ]):([^\]]*)\]$/; // インラインフィールド ([K:G], [M:3/4] など)
